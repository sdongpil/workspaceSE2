...
public class UserDao {
	...
	// 아이디찾기
	public String findByUserId(String user_name, String user_phone) throws Exception {
		String user_id = null;
		Connection con = dataSource.getConnection();
	...
	// 비밀번호찾기
	public String findByUserPw(String user_id, String user_name) throws Exception {
		String user_pw = null;
		Connection con = dataSource.getConnection();
