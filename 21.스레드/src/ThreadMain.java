...
public class ThreadMain {
    public static void main(String[] args) {
        System.out.println("main thraed start");
/*
현재코드를 실해 시키는 메인쓰레드의 쓰레드 객체
 */

        Thread thread = Thread.currentThread();
        System.out.println("main thread name:" + thread.getName());
        System.out.println("main thread priority: " + thread.getPriority());
        MainThreadCalled main = new MainThreadCalled();
    	main.maing_thread_called_method();
        System.out.println("main thrade end");
        return;
