...
//        DuoMember m1 = new DuoMember(2000, "신명숙");
//        DuoMember m2 = new DuoMember(1000, "김철수");
//        m1.print();
//        m2.print();
//
...
//        m2.print();
        ...
        System.out.println("----기본형 변수 초기값----");
        int tot = 0;
        double avg = 0.0;
        char c = '\u0000';
        boolean isMarried = false;
        System.out.println("---참조형 변수 초기값---");
        DuoMember m3 = null;
        /* null 객체주소 리터럴값
        객체주소값 초기화의 용도로 사용
        null주소 사용시 NullPointException 이 발생
         */

        if (m3 == null) {
            m3 = new DuoMember(3, "사식이");
        } else {
            m3.print();
        }
