...
public class EchoServerFrame extends JFrame {
	...
	public EchoServerFrame() {
		...
		displayTA.setFont(new Font("��������ڵ�", Font.BOLD, 16));
	...
	public class EchoServerThread extends Thread {
		...
		public void run() {
			try {
				...
				display("3.EchoServerThread:서버쪽소켓으로부터 입력,출력스트림생성");
				String echo = in.readLine();
				display("4.EchoServerThread:입력스트림을사용해서 클라이언트전송데이타읽기");
				display("5.EchoServerThread:클라이언트로부터읽은데이타" + echo);
