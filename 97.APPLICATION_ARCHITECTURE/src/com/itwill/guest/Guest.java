...
public class Guest { 
	...
	public Guest(int guest_no, String guest_name, Date guest_date, String guest_eamil, String guest_homepage,
			String guest_title, String guest_content) {
		super();
		this.guest_no = guest_no;
		this.guest_name = guest_name;
		this.guest_date = guest_date;
		this.guest_eamil = guest_eamil;
	...
	public String getGuest_eamil() {
		return guest_eamil;
	}
	public void setGuest_eamil(String guest_eamil) {
		this.guest_eamil = guest_eamil;
	}
	...
	public String toString() {
		return "Guest [guest_no=" + guest_no + ", guest_name=" + guest_name + ", guest_date=" + guest_date
				+ ", guest_eamil=" + guest_eamil + ", guest_homepage=" + guest_homepage + ", guest_title=" + guest_title
